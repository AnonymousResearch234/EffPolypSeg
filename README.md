<h1 style="font-size: 32px; font-weight: bold; color: black;">
  EffPolypSegNet: An Efficient Deep Learning Algorithm for Polyp Segmentation in Colonoscopy
</h1>
The implementation and experimental setup are provided as supplementary materials to support the findings presented in our manuscript, "EffPolypSegNet: An Efficient Deep Learning Algorithm for Polyp Segmentation in
Colonoscopy".
